 ...
 * the information needed to return a book.
 * 
 ...
 * @version 1.0
 */
public class BackBookTableModel extends DefaultTableModel {
	private static final long serialVersionUID = 1L;
	private static final String[] HEADER = { "Restituisci", "Titolo", "Autori", "ISBN", "Categoria", "Data prestito",
			"Data restituzione" };
	private ArrayList<Loan> loansList;
	private Object[][] viewLoans;

	/**
	 * Create a new object <code>BackBookTableModel</code> with the informations
	 * contains in the loans list
	 * 
	 * @param loansList
	 *            the list contains the loans to be shown
	 */
	public BackBookTableModel(ArrayList<Loan> loansList) {
		super();
	...
	public int getRowCount() {
		if (this.viewLoans == null) {
			return 0;
		} else {
			return viewLoans.length;
		}
	}
