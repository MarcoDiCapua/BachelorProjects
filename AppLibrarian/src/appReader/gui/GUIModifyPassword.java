...
public class GUIModifyPassword extends JDialog {
	...
	private final Dimension frameDimension = new Dimension(1100, 370);
	...
	public static void main(JDialog frame) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GUIModifyPassword dialog = new GUIModifyPassword(frame);
	...
	private GUIModifyPassword(JDialog frame) {
		super(frame, true);
		setResizable(false);
		...
		gbl_panelGridFields.rowHeights = new int[] { 0, 0, 26, 26, 26, 26, 26, 26, 0 };
