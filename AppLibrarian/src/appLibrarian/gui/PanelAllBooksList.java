...
public class PanelAllBooksList extends JPanel {
	...
	public PanelAllBooksList() {
		...
		panelFilters.setPreferredSize(new Dimension(300, 230));
		...
		tableBooks.setPreferredScrollableViewportSize(new Dimension(450, 450));
		...
		worker = new TableWorker(Operation.LIBRARY_UPDATE_BOOKS, 1, null, tableBooks, null, panelPages, checkBoxCategory,
				textFieldAuthor, textFieldTitle);
		worker.execute();
