...
/**
 * This class create the overwhelming loans list panel
 *
 ...
 * @version 1.0
 */
public class PanelOverwhelmingLoansList extends JPanel {
	 ...
	 * Create the panel
	 */
	public PanelOverwhelmingLoansList() {
		super();
		setBorder(null);
		...
		AllLoansTableModel tm = new AllLoansTableModel(loans);
		...
		worker = new TableWorker(Operation.LIBRARY_ALL_OVERWHELMING_LOANS, 1, null, tableLoans, null, panelPages,
		...
		textFieldTitle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				worker = new TableWorker(Operation.LIBRARY_OVERWHELMING_LOANS_FILTER, 1, params, tableLoans, null,
