...
/**
 * This class create the all loaned books list panel
 *
 ...
 * @version 1.0
 */
public class PanelLoanedBooksList extends JPanel {
	...
	public PanelLoanedBooksList() {
		...
		worker = new TableWorker(Operation.LIBRARY_UPDATE_LOANS, 1, null, tableLoans, null, panelPages,
		...
		textFieldTitle.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				worker = new TableWorker(Operation.LIBRARY_LOANS_FILTER, 1, params, tableLoans, null, panelPages,
						checkBoxCategory, textFieldTitle, textFieldAuthor);
				worker.execute();
			}
		});
